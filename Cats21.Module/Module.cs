...
namespace Cats21.Module {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed partial class Cats21Module : ModuleBase {
        static Cats21Module() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<Cats21DbContext>());
            // #endif 
        }
        public Cats21Module() {
            InitializeComponent();
